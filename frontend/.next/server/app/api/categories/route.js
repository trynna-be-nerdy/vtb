"use strict";(()=>{var e={};e.id=961,e.ids=[961],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},7790:e=>{e.exports=require("assert")},8893:e=>{e.exports=require("buffer")},4770:e=>{e.exports=require("crypto")},665:e=>{e.exports=require("dns")},7702:e=>{e.exports=require("events")},2048:e=>{e.exports=require("fs")},8216:e=>{e.exports=require("net")},9801:e=>{e.exports=require("os")},5315:e=>{e.exports=require("path")},6119:e=>{e.exports=require("perf_hooks")},6162:e=>{e.exports=require("stream")},4026:e=>{e.exports=require("string_decoder")},2452:e=>{e.exports=require("tls")},4175:e=>{e.exports=require("tty")},7360:e=>{e.exports=require("url")},1764:e=>{e.exports=require("util")},916:(e,t,a)=>{a.r(t),a.d(t,{originalPathname:()=>p,patchFetch:()=>E,requestAsyncStorage:()=>d,routeModule:()=>_,serverHooks:()=>g,staticGenerationAsyncStorage:()=>m});var s={};a.r(s),a.d(s,{GET:()=>l,runtime:()=>c});var i=a(9303),r=a(8716),n=a(670),o=a(7070),u=a(7017);let c="nodejs";async function l(){try{let e=await (0,u.CP)();return o.NextResponse.json(e)}catch(e){return console.error("/api/categories error:",e),o.NextResponse.json({error:"Internal server error"},{status:500})}}let _=new i.AppRouteRouteModule({definition:{kind:r.x.APP_ROUTE,page:"/api/categories/route",pathname:"/api/categories",filename:"route",bundlePath:"app/api/categories/route"},resolvedPagePath:"C:\\Users\\sriva\\vtb\\frontend\\app\\api\\categories\\route.ts",nextConfigOutput:"",userland:s}),{requestAsyncStorage:d,staticGenerationAsyncStorage:m,serverHooks:g}=_,p="/api/categories/route";function E(){return(0,n.patchFetch)({serverHooks:g,staticGenerationAsyncStorage:m})}},7017:(e,t,a)=>{a.d(t,{dj:()=>f,Sh:()=>S,IL:()=>$,CP:()=>m,b$:()=>g,Qx:()=>E,jx:()=>d,k3:()=>_,sm:()=>R,KT:()=>p,Mo:()=>y,Si:()=>T,$:()=>O});var s=a(8937);let i=globalThis.__sql??(0,s.Z)(process.env.DATABASE_URL??"postgresql://vtb:vtbpassword@localhost:5432/vtb",{max:10,idle_timeout:20,connect_timeout:10}),r=new Set(["meeting_date","created_at","updated_at","started_at","finished_at"]);function n(e){return Object.fromEntries(Object.entries(e).map(([e,t])=>t instanceof Date?r.has(e)&&t.toISOString().endsWith("T00:00:00.000Z")?[e,t.toISOString().split("T")[0]]:[e,t.toISOString()]:[e,t]))}function o(e){return e.map(n)}var u=a(3475);let c={"schools-education":"Schools & Education","school-construction":"School Construction","budget-finance":"Budget & Finance",transportation:"Transportation","zoning-land-use":"Zoning & Land Use","public-safety":"Public Safety","policy-governance":"Policy & Governance","equity-inclusion":"Equity & Inclusion",technology:"Technology","community-parks":"Community & Parks",personnel:"Personnel",general:"General"},l=Object.keys(c);async function _(e,t,a){let s=`meetings:list:p=${t}:l=${a}:b=${e}`,r=await (0,u.FE)(s);if(r)return r;let n=(t-1)*a,[c,l]=await Promise.all([e?i`SELECT COUNT(*)::int AS total FROM meetings WHERE processing_status = 'completed' AND board_slug = ${e}`:i`SELECT COUNT(*)::int AS total FROM meetings WHERE processing_status = 'completed'`,e?i`
    ...
    GROUP BY primary_category`,s=Object.fromEntries(l.map(e=>[e,0]));for(let e of a)e.slug in s&&(s[e.slug]=e.item_count);let r={categories:l.map(e=>({slug:e,label:c[e],item_count:s[e]}))};return await (0,u.lK)(e,r,u.mJ),r}async function g(e,t,a){if(!(e in c))return null;let s=`categories:feed:${e}:p=${t}:l=${a}`,r=await (0,u.FE)(s);if(r)return r;let n=(t-1)*a,[l,_]=await Promise.all([i`SELECT COUNT(*)::int AS total FROM agenda_items WHERE primary_category = ${e}`,i`
      ...
      LIMIT ${a} OFFSET ${n}`]),d=l[0].total,m={slug:e,label:c[e],items:o(_),pagination:{page:t,limit:a,total:d,has_next:t*a<d}};return await (0,u.lK)(s,m),m}async function p(e,t,a){let s=`search:${e}:p=${t}:l=${a}`,r=await (0,u.FE)(s);if(r)return r;let n=(t-1)*a,[c,l]=await Promise.all([i`
