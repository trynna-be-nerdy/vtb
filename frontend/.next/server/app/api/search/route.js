"use strict";(()=>{var e={};e.id=280,e.ids=[280],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},7790:e=>{e.exports=require("assert")},8893:e=>{e.exports=require("buffer")},4770:e=>{e.exports=require("crypto")},665:e=>{e.exports=require("dns")},7702:e=>{e.exports=require("events")},2048:e=>{e.exports=require("fs")},8216:e=>{e.exports=require("net")},9801:e=>{e.exports=require("os")},5315:e=>{e.exports=require("path")},6119:e=>{e.exports=require("perf_hooks")},6162:e=>{e.exports=require("stream")},4026:e=>{e.exports=require("string_decoder")},2452:e=>{e.exports=require("tls")},4175:e=>{e.exports=require("tty")},7360:e=>{e.exports=require("url")},1764:e=>{e.exports=require("util")},7327:(e,t,a)=>{a.r(t),a.d(t,{originalPathname:()=>g,patchFetch:()=>E,requestAsyncStorage:()=>d,routeModule:()=>_,serverHooks:()=>p,staticGenerationAsyncStorage:()=>m});var s={};a.r(s),a.d(s,{GET:()=>l,runtime:()=>c});var i=a(9303),r=a(8716),n=a(670),o=a(7070),u=a(7017);let c="nodejs";async function l(e){try{let{searchParams:t}=new URL(e.url),a=t.get("q")??"";if(a.length<2||a.length>200)return o.NextResponse.json({error:"Query must be between 2 and 200 characters"},{status:400});let s=Math.max(1,parseInt(t.get("page")??"1",10)),i=Math.min(100,Math.max(1,parseInt(t.get("limit")??"20",10))),r=await (0,u.KT)(a,s,i);return o.NextResponse.json(r)}catch(e){return console.error("/api/search error:",e),o.NextResponse.json({error:"Internal server error"},{status:500})}}let _=new i.AppRouteRouteModule({definition:{kind:r.x.APP_ROUTE,page:"/api/search/route",pathname:"/api/search",filename:"route",bundlePath:"app/api/search/route"},resolvedPagePath:"C:\\Users\\sriva\\vtb\\frontend\\app\\api\\search\\route.ts",nextConfigOutput:"",userland:s}),{requestAsyncStorage:d,staticGenerationAsyncStorage:m,serverHooks:p}=_,g="/api/search/route";function E(){return(0,n.patchFetch)({serverHooks:p,staticGenerationAsyncStorage:m})}},7017:(e,t,a)=>{a.d(t,{dj:()=>f,Sh:()=>S,IL:()=>R,CP:()=>m,b$:()=>p,Qx:()=>E,jx:()=>d,k3:()=>_,sm:()=>h,KT:()=>g,Mo:()=>y,Si:()=>T,$:()=>O});var s=a(8937);let i=globalThis.__sql??(0,s.Z)(process.env.DATABASE_URL??"postgresql://vtb:vtbpassword@localhost:5432/vtb",{max:10,idle_timeout:20,connect_timeout:10}),r=new Set(["meeting_date","created_at","updated_at","started_at","finished_at"]);function n(e){return Object.fromEntries(Object.entries(e).map(([e,t])=>t instanceof Date?r.has(e)&&t.toISOString().endsWith("T00:00:00.000Z")?[e,t.toISOString().split("T")[0]]:[e,t.toISOString()]:[e,t]))}function o(e){return e.map(n)}var u=a(3475);let c={"schools-education":"Schools & Education","school-construction":"School Construction","budget-finance":"Budget & Finance",transportation:"Transportation","zoning-land-use":"Zoning & Land Use","public-safety":"Public Safety","policy-governance":"Policy & Governance","equity-inclusion":"Equity & Inclusion",technology:"Technology","community-parks":"Community & Parks",personnel:"Personnel",general:"General"},l=Object.keys(c);async function _(e,t,a){let s=`meetings:list:p=${t}:l=${a}:b=${e}`,r=await (0,u.FE)(s);if(r)return r;let n=(t-1)*a,[c,l]=await Promise.all([e?i`SELECT COUNT(*)::int AS total FROM meetings WHERE processing_status = 'completed' AND board_slug = ${e}`:i`SELECT COUNT(*)::int AS total FROM meetings WHERE processing_status = 'completed'`,e?i`
